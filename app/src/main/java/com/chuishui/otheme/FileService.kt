...
class FileService(private val context: Context) : IFileService.Stub() {
    ...
    companion object {
        ...
        private const val MODULE_DIR =
            "/data/adb/modules/OThemeTheme"
        private const val THEME_INNER_DIR =
            "/data/adb/modules/OThemeTheme/system_ext/media/themeInner"
     ...
     * 安装主题为 Magisk 模块
     *
     * 将 .theme 文件注入到 Magisk 模块 (/data/adb/modules/OThemeTheme)，
     * 避免修改 /system_ext 等系统分区。Magisk 自动 overlay 到 /system_ext。
    ...
    override fun installTheme(themePath: String): String? {
        ...
        return try {
            ...
            propFile.writeText(
                """
id=OThemeTheme
name=OTheme Theme Module
version=1.0
versionCode=1
author=ChuiShuiMingYue
description=Theme injection module generated by OTheme
minMagisk=23000
""".trimIndent()
            )
